...
export declare class Squiss extends Squiss_base {
    ...
    sendMessage(message: IMessageToSend, delay?: number, attributes?: IMessageAttributes): Promise<SQS.Types.SendMessageResult>;
    sendMessages(messages: IMessageToSend[] | IMessageToSend, delay?: number, attributes?: IMessageAttributes | IMessageAttributes[]): Promise<SQS.Types.SendMessageBatchResult>;
    start(): Promise<void>;
