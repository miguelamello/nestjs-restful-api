...
Obs: Recomendamos que você crie um arquivo `conversor-sbf.service` e rode a aplicação via `systemctl` ou `service` caso esteja usando Linux ou Unix. Se estiver usando outro sistema operacional
