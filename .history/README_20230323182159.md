...
Obs: A completa configuração do Container Docker com a imagem da apliciação, e os detalhes de operação e execução do Docker, fogem do escopo dessa documentação. 
