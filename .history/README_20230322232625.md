...
a. Navegue para o diretório `test` root do projeto.
b. `cd __tests__`. Aka the directory where tests scripts are.
c. Execute the command `./jest` to run all the available tests.
