...
Esse microserviço ja têm inbutido o versátil mecanismo de Logging "Winston". O mecanismo de logging está configurado para enviar qualquer erro que ocorra na aplicação, para o `console.log` do Node. Contudo
